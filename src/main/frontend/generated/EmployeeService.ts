...
import type Employee_1 from "./com/geovannycode/domain/Employee.js";
...
async function save_1(employee: Employee_1 | undefined, init?: EndpointRequestInit_1): Promise<Employee_1 | undefined> { return client_1.call("EmployeeService", "save", { employee }, init); }
...
async function findAll_1(init?: EndpointRequestInit_1): Promise<Array<Employee_1 | undefined> | undefined> { return client_1.call("EmployeeService", "findAll", {}, init); }
export { count_1 as count, delete_1 as delete, deleteAll_1 as deleteAll, exists_1 as exists, findAll_1 as findAll, get_1 as get, list_1 as list, save_1 as save, saveAll_1 as saveAll };
